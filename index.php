...
<strong>Janmesh</strong> (SSID http://janmesh.net) is a citizen-to-citizen networking initiative, running nodes with an active <strong>CoOoOW</strong> stack (<em>cjdns</em> over <em>OLSRD</em> over open WiFi), that provide an alternative communication medium resistant to severely communication network-disruptive situations. <br/>
